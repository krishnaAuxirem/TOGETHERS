...
export const TESTIMONIALS = [
  ...
  { id: '2', name: 'Meera Nair', role: 'Content Creator', location: 'Kerala', avatar: 'https://i.pravatar.cc/150?img=35', rating: 5, text: 'As a creator, TOGETHERS gives me everything I need — from building my community to monetizing my content. I made ₹2.5L last month just from my premium community!' },
...
export const BLOG_POSTS = [
  ...
  { id: '2', title: '10 Ways Creators Are Earning ₹1L+ Monthly on TOGETHERS', excerpt: 'Real stories from Indian creators who built sustainable income through community engagement and premium content.', category: 'Creator Economy', author: 'Arjun Mehta', authorAvatar: 'https://i.pravatar.cc/150?img=12', date: '2025-05-12', readTime: '12 min', tags: ['creator', 'monetization', 'income'], featured: true },
